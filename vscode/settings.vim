...
function! s:manageEditorHeight(...)
    ...
    for i in range(1, count ? count : 1)
        call VSCodeNotify(to ==# 'icrease' ? 'workbench.action.increaseViewHeight' : 'workbench.action.decreaseViewHeight')
    endfor
endfunction
...
xnoremap sj <Cmd>call VSCodeNotify('workbench.action.focusBelowGroup')<CR>
nnoremap sk <Cmd>call VSCodeNotify('workbench.action.focusAboveGroup')<CR>
xnoremap sk <Cmd>call VSCodeNotify('workbench.action.focusAboveGroup')<CR>
nnoremap sh <Cmd>call VSCodeNotify('workbench.action.focusLeftGroup')<CR>
xnoremap sh <Cmd>call VSCodeNotify('workbench.action.focusLeftGroup')<CR>
nnoremap sl <Cmd>call VSCodeNotify('workbench.action.focusRightGroup')<CR>
xnoremap sl <Cmd>call VSCodeNotify('workbench.action.focusRightGroup')<CR>
...
nnoremap tn <Cmd> call VSCodeExtensionNotify('open-file', '__vscode_new__', 0)<CR>
